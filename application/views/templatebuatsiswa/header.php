...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>SC</b>MJ</span>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?=base_url()?>buatsiswa/formubahpassword" class="btn btn-default btn-flat">Ganti Password</a>
                </div>
                <div class="pull-right">
                  <a href="<?=base_url()?>buatsiswa/logoutsiswa" onclick="return confirm('Anda yakin akan keluar dari sistem?')" class="btn btn-default btn-flat">Log out</a>
                </div>
              </li>
            </ul>
          </li>
